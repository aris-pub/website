...
Examples of compliant static fallbacks:

- ✅ Interactive scatter plot → static image of the plot with axis labels + summary data table
- ✅ 3D molecular model → multiple annotated static views from relevant angles
- ✅ Explorable parameter space → default-parameter static figure + descriptive text of key parameter relationships
